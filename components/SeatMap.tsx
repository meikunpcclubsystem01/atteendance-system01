...
// デフォルトの座席レイアウト（APIからの取得に失敗した場合のフォールバック）
...
export default function SeatMap({ selectedSeat, onSelectSeat, occupiedSeats, layout }: SeatMapProps) {
    const seatLayout = layout || DEFAULT_LAYOUT;
